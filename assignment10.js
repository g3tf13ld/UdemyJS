...
var newStory = story.replaceAll("Cheeseburgers", "Hamburgers")
var newStory = newStory.replaceAll("Cheeseburger", "Hamburger")
var newStory = newStory.replaceAll("cheeseburgers", "hamburgers")
var newStory = newStory.replaceAll("cheeseburger", "hamburger")

var newStory = newStory.replaceAll("bun", "BUN")

console.log(newStory)
console.log("Story consists of " + newStory.length + " chars.")
console.log("Story consists of " + newStory.split(" ").length + " words.")